...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Muranga County Referral Hospital</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> MURANG'A COUNTY HOSPITAL </a>
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Receipt Generation</th>
                  </tr>
                </thead>
                <tbody>
                  <?php 
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!--<a href="admin-panel.php?ID=" 
                              ...
                              <input type = "submit" onclick="alert('Bill Paid Successfully');" name ="generate_bill" class = "btn btn-success" value="Generate"/>
                              </a>
                            </td>
                          </form>
                      </tr>
